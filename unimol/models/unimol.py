...
class UniMolModel(BaseUnicoreModel):
    ...
    def __init__(self, args, dictionary):
        ...
        self.mol_linear = nn.Linear(args.encoder_embed_dim, args.clip_dim)
    ...
    def forward(
        ...
        **kwargs
        ...
        ligand_emb = encoder_rep[:,0,:].squeeze(1)
        ligand_emb = self.mol_linear(ligand_emb)
        ligand_norm = torch.norm(ligand_emb, p=2, dim=1, keepdim=True) + 1e-7
        ligand_emb = ligand_emb / ligand_norm
